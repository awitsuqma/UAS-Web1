                            ...
                            <form action="ubahprofile.php" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control" type="text" name="Username" value="<?php echo $user['username'] ?>" id="Username" placeholder="Username">
                                    </div>
                                    <div class="col-md-12">
                                        <label>Email</label>
                                        <input class="form-control" type="text" name="Email" value="<?php echo $user['email'] ?>" id="Email" placeholder="Email">
                                    </div>
                                    <div class="col-md-12">
                                        <label>Password</label>
                                        <input class="form-control" type="password" value="<?php echo $user['password'] ?>" name="Password" id="Password" placeholder="Password">
                                    </div>
                                    <div class="col-md-12">
                                        <button class="btn" type="submit">Perbarui Akun</button>
                                        <br><br>
                                    </div>
                            </form>
                        </div>
