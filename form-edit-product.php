            ...
            <div class="col-md-8">
                <div class="card text-left">
                    ...
                    <div class="card-body justify-content-center">
                        <form action="ubahproduct.php?id=<?php echo $id ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="about" id="about" placeholder="Perusahaan ini berdiri sejak.....">
                            </div>
...
<div class="row ">
    <div class="col-md-12 text-center">
        <p class="font-weight-bold">18111019_AwitSuqma_TIFRP181CIDB_UASWEB1</p>
    </div>
</div>
