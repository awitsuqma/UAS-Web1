            ...
            <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto">
                        <!--<a href="halaman-menu-utama.php" class="nav-item nav-link active">Beranda</a>-->
                        
                        <a href="index.php" class="nav-item nav-link">Beranda</a>
                            <a href="halaman-menu-utama.php" class="nav-item nav-link">Produk</a>
                            <a href="halaman-detail.php?id=2" class="nav-item nav-link">Detail Produk</a>
                    ...
                    <div class="navbar-nav ml-auto">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <p class="dropdown-item font-weight-bold">Hi, <?php echo $user['username'] ?></p>
                                        ...
                                        <div class="product-item">
                                            ...
                                            <div class="product-image">
                                                ...
                                                <div class="product-action">
                                                    <a href="halaman-detail.php?id=<?php echo $companies[$i]['id_company'] ?>"><i class="fas fa-info-circle"></i></a>
                                                    <a href="deleteProduct.php?id=<?php echo $companies[$i]['id_company'] ?>" onclick="return confirm('Are you sure?')"><i class="fas fa-trash-alt"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
